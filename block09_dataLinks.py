...
from .block08_joinSplitLinks        import joinLinks
from .z_utils                       import serializeArgs, argsToStr
...
# ---------------------------------------------------------------------------------------------------------------------
def _omrolocsalaraa(__print__, __locals__, __args__, __depth__, wrapable):
    # type: (bool, bool, bool, int, Cal) -> Cal
    ...
    if __args__:
        ...
        def wrapper(*args, **kwargs):
            ...
            _omrolocsoladoed(__print__, __locals__, __depth__, args=strArgs, returns=returns)
            return returns
        return wrapper
    ...
    def wrapper(*args, **kwargs):
        returns = wrapable(*args, **kwargs)
        _omrolocsoladoed(__print__, __locals__, __depth__, returns=returns)
        return returns
    return wrapper

omrolocsalar = partial(_omrolocsalaraa, False, True , True , 2)
omropocsalar = partial(_omrolocsalaraa, True , True , True , 2)
omrolocsar   = partial(_omrolocsalaraa, False, False, False, 2)
omropocsar   = partial(_omrolocsalaraa, True , False, False, 2)
# ---------------------------------------------------------------------------------------------------------------------
