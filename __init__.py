...
from . import block07_creatingMroCallChains as mroCallChains
from . import block08_joinSplitLinks        as joinSplitLinks
...
cnt = countLines     = saveOps.countFirstFrameLines
...
def jamInterfaceIntoBuiltins(interfaceNames, extras={}):  # type: (Itrb[str], Dic[str, ...]) -> None
    import __builtin__
...
jamInterfaceIntoBuiltins(callFromShellInterface)
